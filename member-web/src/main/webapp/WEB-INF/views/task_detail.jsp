	...
	<div class="container col-md-12" style="padding: 15px 0">
		<div class="col-md-12">
			...
			<form class="layui-form" id="taskForm">
					...
					<input type="hidden" name="id" value="${quartzTask.id}">
						...
						<div class="layui-inline">
							...
							<div class="layui-input-inline">
								<input type="text" name="name" lay-verify="name"
									class="form-control" placeholder="请输入任务名称" value="${quartzTask.name}">
							</div>
						</div>
					</div>
					<div class="layui-form-item">
						<div class="layui-inline">
							...
							<div class="layui-input-inline">
								<input type="text" name="cron" lay-verify="cron"
									class="form-control" placeholder="请输入任务表达式" value="${quartzTask.cron}">
							</div>
						</div>
					</div>
					<div class="layui-form-item">
						<div class="layui-inline">
							...
							<div class="layui-input-inline">
								<input type="text" name="targetBean" lay-verify="targetBean"
									class="form-control" placeholder="请输入执行的类" value="${quartzTask.targetBean}">
							</div>
						</div>
					</div>
						...
						<div class="layui-inline">
							...
							<div class="layui-input-inline">
								<input type="text" name="targetMethod" lay-verify="targetMethod"
									class="form-control" placeholder="请输入执行方法" value="${quartzTask.targetMethod}">
							</div>
						</div>
					</div>
					...
					<div class="layui-form-item">
						<div class="layui-inline">
						    ...
						    <div class="layui-input-inline">
						      <c:choose>
						      	<c:when test="${quartzTask.status == 0}">
						      	...
						      	<c:otherwise>
						      		<input type="radio" name="status" value="0" title="正常">
				      		  		<input type="radio" name="status" value="1" title="暂停"  checked="checked">
						      	</c:otherwise>
						      </c:choose>
						    </div>
						 </div>
					  ...
					  <div class="layui-form-item">
						<div class="layui-inline">
							...
							<div class="layui-input-inline">
								<textarea name="remarks" style="width: 500px;height: 100px;" class="form-control">${quartzTask.remarks}</textarea>
							</div>
						</div>
					</div>
